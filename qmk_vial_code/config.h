...
#define PRODUCT         Positron
#define DESCRIPTION     Maximal TKL-ish ortho 
#define VIAL_KEYBOARD_UID {0x3B, 0x5B, 0x68, 0x28, 0xA8, 0xCA, 0x63, 0xEF}
...
#define MATRIX_COL_PINS { D1, D0, D4, C6, D7, E6, B4, B5, B7, D5, C7, F1, F0, F5 }
